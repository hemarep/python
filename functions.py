...
"""
(Function is a block of code, that can be called once or multiple times.
...
"""
#syntax without arguments def myFunctionName():
#syntax with one argument def myFunctionName(input):
#syntax with multiple arguments def myFunctionName(input1, input2):
...
#printable.
print("\n__Function with return values__")
...
#Function with a TUPLE input parameter
...
#Function with a DICTIONARY input parameter
